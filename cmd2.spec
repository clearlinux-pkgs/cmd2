...
Source0  : https://files.pythonhosted.org/packages/ba/b4/95e99237786d15572c9f80a279799964c5e910fc8c7d40c82dd5b4053108/cmd2-1.0.2.tar.gz
...
%prep
%setup -q -n cmd2-1.0.2
cd %{_builddir}/cmd2-1.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586384480
...
cp %{_builddir}/cmd2-1.0.2/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
