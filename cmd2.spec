...
Source0  : https://files.pythonhosted.org/packages/6a/6c/dddfbf32bd3a83f9aa85bfb8149695a5bd1edb93402a5f232a270a8279b1/cmd2-1.0.1.tar.gz
...
%prep
%setup -q -n cmd2-1.0.1
cd %{_builddir}/cmd2-1.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584294550
...
cp %{_builddir}/cmd2-1.0.1/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
