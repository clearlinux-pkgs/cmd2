...
Source0  : https://files.pythonhosted.org/packages/cc/62/b12c1029be341d1e4de6ca6fe5b9237e2c9c89df01612c20dd1582cb32e0/cmd2-1.3.11.tar.gz
...
%prep
%setup -q -n cmd2-1.3.11
cd %{_builddir}/cmd2-1.3.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601997662
...
cp %{_builddir}/cmd2-1.3.11/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.11/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
