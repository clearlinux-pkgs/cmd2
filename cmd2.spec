...
Version  : 1.3.1
Release  : 76
URL      : https://files.pythonhosted.org/packages/43/df/1352ad37437e4e2bfac94bdff904e4ccfcd42d2905fb5503abf90346ee84/cmd2-1.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/43/df/1352ad37437e4e2bfac94bdff904e4ccfcd42d2905fb5503abf90346ee84/cmd2-1.3.1.tar.gz
...
%prep
%setup -q -n cmd2-1.3.1
cd %{_builddir}/cmd2-1.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597076784
...
cp %{_builddir}/cmd2-1.3.1/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.1/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
