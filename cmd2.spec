...
%prep
%setup -q -n cmd2-2.1.2
cd %{_builddir}/cmd2-2.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625581619
...
cp %{_builddir}/cmd2-2.1.2/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
