...
Version  : 1.3.3
Release  : 78
URL      : https://files.pythonhosted.org/packages/ee/f6/357ece9873e20c3bfb8c45db7eadc2c40c1637abccacda9662451ddcc022/cmd2-1.3.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/ee/f6/357ece9873e20c3bfb8c45db7eadc2c40c1637abccacda9662451ddcc022/cmd2-1.3.3.tar.gz
...
%prep
%setup -q -n cmd2-1.3.3
cd %{_builddir}/cmd2-1.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597358946
...
cp %{_builddir}/cmd2-1.3.3/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.3/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
