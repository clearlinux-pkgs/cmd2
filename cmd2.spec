...
%prep
%setup -q -n cmd2-0.9.22
cd %{_builddir}/cmd2-0.9.22
...
cp %{_builddir}/cmd2-0.9.22/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/686ffadb42227ccf41e55913628304746d4b0590
