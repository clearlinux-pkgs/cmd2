...
Version  : 1.3.0
Release  : 75
URL      : https://files.pythonhosted.org/packages/7b/1d/295c4e6a1d9d0baca08c601e41319c06f772c771da480512cd6d44769fba/cmd2-1.3.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/7b/1d/295c4e6a1d9d0baca08c601e41319c06f772c771da480512cd6d44769fba/cmd2-1.3.0.tar.gz
...
%prep
%setup -q -n cmd2-1.3.0
cd %{_builddir}/cmd2-1.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596638523
...
cp %{_builddir}/cmd2-1.3.0/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.0/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
