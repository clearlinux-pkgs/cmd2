...
%prep
%setup -q -n cmd2-1.4.0
cd %{_builddir}/cmd2-1.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605193582
...
cp %{_builddir}/cmd2-1.4.0/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.4.0/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
