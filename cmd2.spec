...
Version  : 1.3.2
Release  : 77
URL      : https://files.pythonhosted.org/packages/27/21/2ec59c436be9d94449800356fd343cbc759eb016e99f20db9a029ac960ea/cmd2-1.3.2.tar.gz
Source0  : https://files.pythonhosted.org/packages/27/21/2ec59c436be9d94449800356fd343cbc759eb016e99f20db9a029ac960ea/cmd2-1.3.2.tar.gz
...
%prep
%setup -q -n cmd2-1.3.2
cd %{_builddir}/cmd2-1.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597157085
...
cp %{_builddir}/cmd2-1.3.2/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.2/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
