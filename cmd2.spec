...
Source0  : https://files.pythonhosted.org/packages/39/dd/b98a2092500f71e34101e8ae1b439330237e41d327f01eeeb691c9c305ee/cmd2-0.10.0.tar.gz
...
%prep
%setup -q -n cmd2-0.10.0
cd %{_builddir}/cmd2-0.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581185162
