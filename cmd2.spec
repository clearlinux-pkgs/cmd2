...
Source0  : https://files.pythonhosted.org/packages/c7/70/8fcce03e181145ddd146d72e28173837fc41758609a39cb88c77d0e7c829/cmd2-1.3.9.tar.gz
...
%prep
%setup -q -n cmd2-1.3.9
cd %{_builddir}/cmd2-1.3.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1599596998
...
cp %{_builddir}/cmd2-1.3.9/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.9/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
