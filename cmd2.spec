...
Source0  : https://files.pythonhosted.org/packages/9e/32/17db9faac96ee3255e2e6b20fab184599996dae0e0ebbaf822688a90893b/cmd2-2.1.1.tar.gz
...
%prep
%setup -q -n cmd2-2.1.1
cd %{_builddir}/cmd2-2.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624026773
...
cp %{_builddir}/cmd2-2.1.1/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-2.1.1/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
