...
Version  : 1.0.0
Release  : 70
URL      : https://files.pythonhosted.org/packages/05/55/19b3445071e93bfc3854b47683ca6ab884bedc617045cbaa3eeed75d4860/cmd2-1.0.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/05/55/19b3445071e93bfc3854b47683ca6ab884bedc617045cbaa3eeed75d4860/cmd2-1.0.0.tar.gz
...
%prep
%setup -q -n cmd2-1.0.0
cd %{_builddir}/cmd2-1.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583158782
...
cp %{_builddir}/cmd2-1.0.0/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
