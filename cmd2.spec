...
Source0  : https://files.pythonhosted.org/packages/d3/1e/224b4d3fcf96e5fa571efa0deb0a9a0485e7582ff76f1b6351dc0fe9a355/cmd2-1.2.1.tar.gz
...
%prep
%setup -q -n cmd2-1.2.1
cd %{_builddir}/cmd2-1.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594822630
...
cp %{_builddir}/cmd2-1.2.1/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
