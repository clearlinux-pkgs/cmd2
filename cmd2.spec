...
Version  : 1.3.4
Release  : 79
URL      : https://files.pythonhosted.org/packages/b2/13/113999e11d2e087be5622ac45b57c9bface83a8ffa8949311d63107ae01e/cmd2-1.3.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/b2/13/113999e11d2e087be5622ac45b57c9bface83a8ffa8949311d63107ae01e/cmd2-1.3.4.tar.gz
...
%prep
%setup -q -n cmd2-1.3.4
cd %{_builddir}/cmd2-1.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598020879
...
cp %{_builddir}/cmd2-1.3.4/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/034107bef270506011745fc01e2c80493ef9421f
cp %{_builddir}/cmd2-1.3.4/plugins/template/LICENSE %{buildroot}/usr/share/package-licenses/cmd2/3e6eb52ad8a3906e168e16d4a635f441ff29e02b
